...
export class ReportsService {
    ...
    async getResume(): Promise<Object> {
        ...
        const cars = this.vehicleRepository.count({where: {vehicleType: VehicleType.CAR}})
        const motorcycles = this.vehicleRepository.count({where: {vehicleType: VehicleType.MOTORCYCLE}})
